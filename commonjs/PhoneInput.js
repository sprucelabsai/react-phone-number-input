...
var PhoneNumberInput = (0, _reactLifecyclesCompat.polyfill)(_class = (_temp = _class2 = function (_PureComponent) {
   ...
   */
  flags: _propTypes2.default.objectOf(_propTypes2.default.element),
   ...
   */
  flagComponent: _propTypes2.default.element.isRequired,
  ...
  //
  countrySelectComponent: _propTypes2.default.element.isRequired,
   ...
   */
  numberInputComponent: _propTypes2.default.element.isRequired,
   ...
   * @ignore
   */
  inputComponent: _propTypes2.default.element.isRequired,
...
function createCountrySelectOptionIconComponent(props) {
  ...
  return function (_ref2) {
    ...
    return _react2.default.createElement(
      ...
      value ? _react2.default.createElement(FlagComponent, { country: value, flags: flags, flagsPath: flagsPath }) : _react2.default.createElement(InternationalIcon, null)
    );
  };
}
